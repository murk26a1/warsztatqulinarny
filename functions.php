...
function custom_scripts() {
	...
	wp_deregister_script( 'jquery-migrate' );
		...
		wp_enqueue_style( 'main_css', get_template_directory_uri() . '/dist/css/main.min.css', NULL , '1.1.3' );
...
add_filter( 'max_srcset_image_width', 'remove_max_srcset_image_width' );
  ...
  function img_resp($image_id,$image_size,$max_width){
	...
	if($image_id != '') {
		...
		echo  'alt="'.$image_alt.'" src="#" data-src="'.$image_src.'" data-srcset="'.$image_srcset.'" data-sizes="(max-width: '.$max_width.') 100vw, '.$max_width.'"';
...
function custom_breadcrumbs() {
    ...
    if ( !is_front_page() ) {
        ...
        echo '<nav class="bc"><ul id="' . $breadcrums_id . '" class="' . $breadcrums_class . '">';
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            if(!empty($category)) {
                ...
                foreach($cat_parents as $parents) {
                    $cat_display .= '<li><a href="https://warsztatqulinarny.pl/blog">Blog</a></li>  <li class="separator"> ' . $separator . ' </li> <li class="item-cat">'.$parents.'</li>';
            ...
            // Category page
            echo '<li><a href="https://warsztatqulinarny.pl/blog">Blog</a></li>  <li class="separator"> ' . $separator . ' </li> <li class="item-current item-cat"><strong class="bread-current bread-cat">' . single_cat_title('', false) . '</strong></li>';
