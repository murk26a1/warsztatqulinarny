...
<main>
    ...
    ?>
        ...
        <section id="section-banner" style="background-image: url('<?php echo $img; ?>');">
            ...
            if (!wp_is_mobile()) { ?>
                <div class="ill-img">
                    ...
                    <img class="food1 b-fadeInRight" src="<?php echo $img; ?>/img/ill/zdj/food-t.png" alt="icon" />
                    <img class="food2 b-fadeInLeft" src="<?php echo $img; ?>/img/ill/zdj/food-t2.png" alt="icon" />
                </div>
            <?php } ?>
        ...
        <section id="section-black-bg">
            ...
            <img class="lazy opacity-d" <?php img_resp(get_field('masz_pytania_zdjecie'), 'xl', '1920px'); ?>  />
        </section>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="d-none d-md-block col-md-4">
                        <div class="left">
                            <img class="lazy opacity-d" <?php img_resp(get_field('zdjecie_-_lewe'), 'xl', '1366px'); ?>  />
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="up">
                            <img class="lazy opacity-d" <?php img_resp(get_field('zdjecie_-_gora'), 'medium', '600px'); ?>  />
                        </div>
                        <div class="mid">
                        ...
                        <div class="down">
                            <img class="lazy opacity-d" <?php img_resp(get_field('zdjecie_-_dol'), 'medium', '600px'); ?>  />
                        </div>
                    </div>
                    <div class="d-none d-md-block col-md-4">
                        <div class="right">
                            <img class="lazy opacity-d" <?php img_resp(get_field('zdjecie_-_prawe'), 'xl', '1366px'); ?>  />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="section-video">
            <video class="lazy" loop="loop" poster="<?php echo get_theme_file_uri(); ?>/img/poster.jpg" autoplay muted>
                <source src="#" data-src="<?php echo get_theme_file_uri(); ?>/img/vid_c.mp4" type="video/mp4">
            </video>
        </section>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6 col-no-padding">
                        <div class="wrapper">
                            <div class="img">
                                <img class="lazy opacity-d" <?php img_resp(get_field('o_mnie_zdjecie'), 'xl', '1920px'); ?>  />
                            </div>
                            <div class="half-img">
                            </div>
                        </div>
